    ...
    return(
        <div className="mini-terminal">
            <div className="top-of-terminal-window">
                ...
                <p className="terminal-title">km.sys@portfolio — zsh — 80x24</p>
            </div>
            <div className="terminal-content">
                <p className="last-login">Last login: Mon Oct 30 10:00:00 2023 from 192.168.1.1</p>
                <p className="command"><span className="user">km.sys</span> ~ cat about_me.md</p>
                ...
                <p className="command"><span className="user">km.sys</span> ~ ls skills/active</p>
